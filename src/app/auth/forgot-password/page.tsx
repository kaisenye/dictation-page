...
export default function ForgotPasswordPage() {
  ...
  return (
    <AuthLayout title="Reset your password" subtitle="We’ll send you a reset link by email">
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <Button type="submit" className="w-full" disabled={!isValidEmail(email) || status === "sending"}>
