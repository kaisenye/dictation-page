    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="container mx-auto px-4 pt-36 pb-20">
        <article className="max-w-2xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-medium text-gray-900 mb-4 text-center">
            {post.title}
          </h1>
          ...
          {post.mainImage && (
            <div className="relative w-full h-[300px] md:h-[400px] mb-10 rounded-xl overflow-hidden bg-gray-100">
              <Image
          ...
          <div className="mt-12 pt-8">
            <div className="flex flex-col gap-2 text-sm">
              ...
              <p className="text-gray-900 mt-4">Author</p>
              <p className="text-gray-600">Romo Team</p>
            </div>
          </div>
            ...
            <div className="mt-16 pt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {otherPosts.map((otherPost) => (
                  ...
                  >
                    {otherPost.mainImage && (
                      <div className="relative w-full aspect-video mb-4 rounded-lg overflow-hidden bg-gray-200">
                        <Image
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2 group-hover:text-gray-700 transition-colors line-clamp-2">
                      {otherPost.title}
                    </h3>
                    {otherPost.excerpt && (
