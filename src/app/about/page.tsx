        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="space-y-8 text-center">
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                We believe in the fundamental right to privacy. That's why Romo runs entirely on your local machine. No
                data is sent to external servers, no cloud processing, no tracking. Your conversations, your data, your
                control.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                Optimized for macOS, Romo takes full advantage of Apple's powerful hardware. Whether you're using Apple
                Silicon or Intel processors, Romo delivers smooth, responsive performance that enhances your daily
                workflow.
              </p>
            </section>
          </div>
