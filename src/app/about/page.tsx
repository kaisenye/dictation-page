  ...
  return (
    <div className="bg-black text-white ">
      ...
      <EmergeAnimation delay={100}>
        <div className="container mx-auto px-8 pt-36 pb-12 md:pb-24">
          <div className="max-w-sm mx-auto">
            ...
            <div className="space-y-8 text-center">
              <section>
                <h2 className="text-xl font-medium mb-4">Build for Everyone</h2>
              ...
              <section>
                <h2 className="text-xl font-medium mb-4">Privacy First</h2>
                <p className="text-base text-gray-300 leading-relaxed">
                  We believe in the fundamental right to privacy. That&apos;s
                  why Romo runs entirely on your local machine. No data is sent
                  to external servers, no cloud processing, no tracking. Your
                  conversations, your data, your control.
                </p>
              </section>

              <section>
                <h2 className="text-xl font-medium mb-4">Built for Mac</h2>
                <p className="text-base text-gray-300 leading-relaxed">
