        ...
        <Container className="mx-auto py-10 px-5 max-w-2xl">
          ...
          <Section className="bg-neutral-50 border border-neutral-200 rounded-lg p-8 mb-8">
            ...
            <Text className="text-neutral-600 text-base leading-relaxed mt-0 mb-6">
              ...
              <strong className="text-neutral-700">Romo Agent</strong> - the
              AI-powered assistant that will revolutionize how you interact with
              your computer through voice.
            </Text>

            {/* What to Expect */}
            <Section className="my-8">
              <Heading className="text-neutral-900 text-lg font-bold mb-4">
                What to expect:
              </Heading>
            ...
            <Section className="bg-neutral-100 rounded-md p-5 my-6">
              <Heading className="text-neutral-700 text-base font-bold mt-2 mb-3">
                While you wait...
              </Heading>
              <Text className="text-neutral-600 text-base leading-relaxed mt-0 mb-4">
                Try our free version of Romo! It&apos;s already packed with
                powerful features and completely free.
              </Text>
            ...
            {/* Timeline */}
            <Section className="my-8">
              <Heading className="text-neutral-900 text-base font-bold mt-8 mb-3">
                Expected Timeline:
              </Heading>
              <Text className="text-neutral-500 text-sm leading-relaxed m-0">
                We&apos;re aiming for November 2025. You&apos;ll receive updates
